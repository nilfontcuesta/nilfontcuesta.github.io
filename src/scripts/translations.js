const translations = {
    ...
    es: {
        ...
        "ajuntament-description": "Cargo público en el Ayuntamiento de Barcelona durante el mandato 2019-2023. (Media jornada)",
        ...
        "skills-languages-description": "Catalán (nativo), Español (nativo), Inglés (Competencia laboral profesional)",
        "skills-programming-title": "Lenguajes de Programación",
        "skills-programming-description": "Kotlin, Java, Python, Go, PHP, TypeScript, JavaScript, C, C++",
        "skills-frameworks-title": "Frameworks/Libraries",
        "skills-frameworks-description": "Ktor, SpringBoot, Django, Laravel, FastAPI, React, AngularJS",
        "skills-technologies-title": "Otras tecnologías",
        "skills-technologies-description": "AWS (ECS, DynamoDB, RDS, Cloud Formation...), Grafana, InfluxDB, Kafka, RabbitMQ",
